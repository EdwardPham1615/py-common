...
from py_common.config.environment import (
    ENVIRONMENT_VAR,
    Environment,
    resolve_env_files,
    resolve_environment,
...
class HttpSettings(BaseModel):
    ...
    :func:`~py_common.http.middleware.apply_standard_middleware`.
    """
    ...
    # :func:`~py_common.security.auth.internal_router`, sent as ``X-API-Key``.
...
class BaseAppSettings(BaseSettings):
    ...
    second (see :func:`~py_common.config.environment.resolve_environment`), so
