...
# pip
pip install "pycommon[all] @ git+https://github.com/EdwardPham1615/pycommon.git@v0.2.0"
```
...
Example: `uv add "pycommon[http,persistence,runtime] @ git+https://github.com/EdwardPham1615/pycommon.git@v0.2.0"`
